...
header_text = '''
    <html>\n<head> <title>EB Flask Show</title> </head>\n<body>'''
sender = "<p>From Elastic Beanstalker: </p>\n"
instructions = '''
...
application.add_url_rule("/", "index", (lambda: header_text + sender + say_hello() + instructions + footer_text))
